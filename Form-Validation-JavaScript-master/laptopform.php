<?php
  ...
  if($_SERVER['REQUEST_METHOD']=="POST")
  {
    ...
    {
      $query = "insert into laptopform (name,email,phone,address,lname,description) values ('$fullname','$gmail','$phone','$add','$lname','$description')";
...
<div class="container">
    ...
    <form action="#" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="product_name">Laptop Name:</label>
            <input type="text" id="product_name" name="lname" required>
        </div>
        <div class="form-group">
        ...
        <div action="#" method="post" enctype="multipart/form-data">
            <label for="product_img"><b>Laptop Image:</b></label><br>
